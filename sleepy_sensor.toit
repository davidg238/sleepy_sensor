...
main:
  ...
  message ::= "{\"ti\": \"$Time.now.local\", \"id\": \"$board.short_id\", \"t\": $(%.1f bme.read_temperature), \"h\": $(%.1f bme.read_humidity), \"p\": $(%.1f bme.read_pressure/100), \"v\": $(%.3f board.battery_voltage)}"
  // message ::= tison.encode [Time.now.to_byte_array, (hardware_id.stringify)[24..], bme.read_temperature, bme.read_humidity, bme.read_pressure/100]
  print message
